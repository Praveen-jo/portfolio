        ...
        <Card>
          ...
          <CardContent>
            <div className="text-base lg:text-lg space-y-4">
              ...
              <p className="mb-2 text-sm">We use collected information to:</p>
              <ul className="list-disc list-inside ml-5 mt-2 mb-2 text-sm">
              ...
              <p className="mb-2 text-sm">We use industry-standard security measures (encryption in transit via HTTPS, access controls, and secure hosting) to protect personal data. We regularly review our security practices but cannot guarantee that unauthorized access, hacking, or data loss will never occur. Report suspected breaches to praveenjoofficial05@gmail.com immediately.</p>

              <h4 id="rights" className="mt-4 font-semibold">Your Rights</h4>
              <p className="mb-2 text-sm">You may have rights under applicable data protection laws including to access, correct, update, or delete your personal data. Subject to verification and applicable exceptions, you may also have rights to restrict or object to processing and to request portability of your data. To exercise your rights, send a request to praveenjoofficial05@gmail.com. We may ask for information to verify your identity before fulfilling requests.</p>
              ...
              <p className="mb-2 text-sm">For privacy requests or questions, contact: <a className="underline text-primary" href="mailto:praveenjoofficial05@gmail.com">praveenjoofficial05@gmail.com</a>. For legal requests, contact <a className="underline text-primary" href="mailto:praveenjoofficial05@gmail.com">praveenjoofficial05@gmail.com</a>. For privacy-related disputes, please include sufficient information to identify your request and allow us to respond promptly.</p>
