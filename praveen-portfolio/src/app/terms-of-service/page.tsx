    ...
    <main className="max-w-5xl mx-auto pt-20 sm:pt-24 pb-12 px-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mb-2 text-sm">For questions about these Terms or to serve legal notices: <a className="underline text-primary" href="mailto:praveenjoofficial05@gmail.com">praveenjoofficial05@gmail.com</a>. For legal notices: <a className="underline text-primary" href="mailto:praveenjoofficial05@gmail.com">praveenjoofficial05@gmail.com</a>.</p>
