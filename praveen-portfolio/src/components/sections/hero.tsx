...
import { ArrowRight, ArrowUpRightIcon, Zap } from "lucide-react";
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            >
              <AnnouncementTag className="truncate">Lastest update</AnnouncementTag>
          ...
          <div className="space-y-4 sm:space-y-6">
            <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl xl:text-[8rem] font-extrabold tracking-tight leading-none text-foreground">
            ...
            <p className="mx-auto max-w-2xl sm:max-w-3xl text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-muted-foreground leading-relaxed px-4 sm:px-0">
              I Build Next-Generation Web Experiences.
            </p>
          </div>
          ...
          >
            ...
            >
              <Link href="/contact">
                Get in Touch
                <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1 text-muted-foreground dark:text-muted-foreground/80" />
              </Link>
            </Button>
          </motion.div>
        </motion.div>
